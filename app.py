...
# Pre-computed rigorously validated benchmark metrics on holdout test set (51,070 samples)
BENCHMARK_METRICS = {
    "Gradient Boosting": {
        "Category": "Boosting",
        "Accuracy": 0.6905,
...
# ============================================================
# 3. GLOBAL CUSTOM CSS — OBSIDIAN & EMERALD LUXE RESPONSIVE FINTECH
# ============================================================
def inject_custom_css():
    st.markdown(
        ...
        *, *::before, *::after {
        ...
        /* ============================================================
           2. LUXE NAVBAR & STATUS BADGES (RESPONSIVE)
           ============================================================ */
        .lg-navbar {
        ...
        /* ============================================================
           5. METRIC BOXES & GRIDS (FLUID RESPONSIVE)
           ============================================================ */
        .lg-metric-grid {
            display: grid;
        ...
        .lg-metric-grid.grid-4 {
            grid-template-columns: repeat(4, 1fr);
        }
        .lg-metric-grid.grid-3 {
            grid-template-columns: repeat(3, 1fr);
        }
        .lg-metric-grid.grid-2 {
        ...
        /* ============================================================
           6. MASTER COMPARISON TABLE (TOUCH-SCROLLABLE)
           ============================================================ */
        .lg-table-container {
            ...
            scrollbar-color: rgba(16, 185, 129, 0.4) rgba(10, 16, 30, 0.8);
            width: 100%;
        }
        .lg-table-container::-webkit-scrollbar {
            height: 6px;
        }
        .lg-table-container::-webkit-scrollbar-track {
            background: rgba(10, 16, 30, 0.8);
            border-radius: 4px;
        }
        .lg-table-container::-webkit-scrollbar-thumb {
        ...
        /* ============================================================
           7. TABS & NAV-ELEMENTS (RESPONSIVE TOUCH-SCROLL)
           ============================================================ */
        ...
        /* Plotly charts responsive safety */
        ...
        /* ============================================================
           8. MEDIA QUERIES FOR TABLETS & LAPTOPS (<= 992px)
           ============================================================ */
        ...
        /* ============================================================
           9. MEDIA QUERIES FOR PHABLETS & MOBILES (<= 768px)
           ============================================================ */
        @media (max-width: 768px) {
            ...
            .lg-consensus-box > div:last-child {
        ...
        /* ============================================================
           10. MEDIA QUERIES FOR COMPACT SMARTPHONES (<= 480px)
           ============================================================ */
        ...
        /* ============================================================
           11. MEDIA QUERIES FOR ULTRA COMPACT SCREENS (<= 340px)
           ============================================================ */
...
# ============================================================
# 5. PAGE 1: SINGLE LOAN RISK ASSESSMENT (9-MODEL SUITE)
# ============================================================
def render_single_prediction_page():
    ...
    with col_results:
        if "Committee" in eval_mode or "Consensus" in eval_mode:
            ...
            # Dynamic Grid of All Loaded Models (3 per row)
            ...
            st.plotly_chart(gauge_main, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
            ...
            st.plotly_chart(gauge_single, use_container_width=True, config={'displayModeBar': False, 'responsive': True})

        # Key Financial Metrics Grid
        st.markdown(f"""
            <div class="lg-metric-grid grid-4">
    ...
    with tab_rf:
        ...
        if "rf" in models_pool:
            ...
            st.plotly_chart(rf_chart, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
    ...
    with tab_lr:
        ...
        if "lr" in models_pool:
            ...
            st.plotly_chart(wf_fig, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
...
# ============================================================
# 6. PAGE 2: MODEL COMPARISON & BENCHMARK (ALL 8 MODELS)
# ============================================================
def render_model_comparison_page():
    ...
    # Top KPI Highlights
    st.markdown("""
        <div class="lg-metric-grid grid-4" style="margin-bottom: 24px;">
...
{rows_html}
    ...
    with comp_tab2:
        ...
        with cm_r1:
            ...
            st.plotly_chart(fig_gb_cm, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
        ...
        with cm_r2:
            ...
            st.plotly_chart(fig_rf_cm, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
    ...
    with comp_tab3:
        ...
        st.plotly_chart(roc_fig, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
...
def render_batch_analytics_page():
    ...
    if batch_df is not None:
        ...
        # Calculate consensus dynamically
...
def render_eda_page():
    ...
    with eda_tab1:
        ...
        with c1:
            ...
            st.plotly_chart(fig_age, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
        with c2:
            ...
            fig_ir.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", title_font=dict(color="#38BDF8", size=13), height=300)
            st.plotly_chart(fig_ir, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
    ...
    with eda_tab3:
        ...
        st.plotly_chart(fig_scatter, use_container_width=True, config={'displayModeBar': False, 'responsive': True})
...
def render_affordability_calculator_page():
    ...
    with col2:
        ...
        st.markdown(f"""
            <div class="lg-metric-grid grid-3">
                <div class="lg-metric-box">
                    <div class="lg-metric-label">Total Payment</div>
                    <div class="lg-metric-val">${total_pay:,.0f}</div>
                </div>
...
# ============================================================
# 11. MAIN ROUTER & SIDEBAR CONTROLLER
# ============================================================
def main():
    inject_custom_css()
